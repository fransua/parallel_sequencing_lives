...
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o "$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )/../../../.."/scripts/pipelines/hic-16.05/job_out/job_dc3a1e069_51720e9cf_2017_06_29_full_no_downstream_bam_no_dekker_call_hic-16.05_$JOB_ID.out
#$ -e "$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )/../../../.."/scripts/pipelines/hic-16.05/job_out/job_dc3a1e069_51720e9cf_2017_06_29_full_no_downstream_bam_no_dekker_call_hic-16.05_$JOB_ID.err
#$ -j y
...
path_job_file="$( cd "$( dirname "${BASH_SOURCE[0]}" )" && pwd )/../../../.."/scripts/pipelines/hic-16.05/job_cmd/job_dc3a1e069_51720e9cf_2017_06_29_full_no_downstream_bam_no_dekker_call_hic-16.05.sh
